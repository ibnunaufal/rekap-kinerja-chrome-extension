...
Untuk saat ini ekstensi belum tersedia di Chrome Web Store, namun anda dapat mengunduhnya lalu menginstallnya secara manual. Ikuti langkah berikut ini.
...
- [@ibnunaufal](https://naufall.com)

___


# Rekap Kinerja (English Version)

A tools to help ASN that use E-Kinerja from BKN to recap their daily report into a weekly or monthnly (*soon) report.

Right now the extension hasn't published on Chrome Web Store but people can download the .crx file then install it manually. Follow the installation guide
